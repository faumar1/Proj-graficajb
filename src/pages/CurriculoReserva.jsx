  ...
  return (
    <Box sx={{ minHeight: 'calc(100vh - 64px)', width: '100vw', display: 'flex', alignItems: 'flex-start', justifyContent: 'center', bgcolor: '#f5f5f5' }}>
      <Box sx={{ maxWidth: 700, width: '100%', py: 4, mt: 6 }}>
        <Paper sx={{ p: 4 }}>
          <Typography variant="h5" fontWeight={700} mb={2}>Cadastro de Currículo Reserva</Typography>
          {success && <Alert severity="success" sx={{ mb: 2 }}>Currículo cadastrado com sucesso!</Alert>}
          <form onSubmit={handleSubmit}>
            <Grid container spacing={2}>
              ...
              <Grid item xs={12} sm={6}>
                <TextField label="Área de Interesse" fullWidth required />
              </Grid>
              <Grid item xs={12}>
              ...
              <Grid item xs={12}>
                <Button type="submit" variant="contained" color="primary" fullWidth size="large">Cadastrar Currículo Reserva</Button>
              </Grid>
            </Grid>
          </form>
        </Paper>
...
export default CurriculoReserva; 